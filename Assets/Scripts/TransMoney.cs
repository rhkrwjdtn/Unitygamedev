...
public class TransMoney : MonoBehaviour {
	...
	public string strTransMoney(ulong moneytransform){
		...
		if (won > 0 && man == 0 && uck == 0 && jo == 0 && kyung == 0)
			...
			strMoney = System.Convert.ToString (man) + "경";
		else if (won >= 0 && man >= 0 && uck == 0 && jo >= 0 && kyung > 0)
			strMoney = System.Convert.ToString (man) + "경" + System.Convert.ToString (jo) + "조";
		else if (won >= 0 && man >= 0 && uck >= 0 && jo >= 0 && kyung > 0)
			strMoney = System.Convert.ToString (man) + "경" + System.Convert.ToString (jo) + "조" + System.Convert.ToString (uck) + "억";
